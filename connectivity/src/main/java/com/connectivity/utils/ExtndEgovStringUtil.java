...
public class ExtndEgovStringUtil
{
	 ...
	 * </p>
	 */
	// private final int PAD_LIMIT = 8192;
	/**
	 * <p>
	 ...
	 */
	/*
	 * private final String[] PADDING = new String[Character.MAX_VALUE];
	 * {
	 ...
	 */
	public String getStringFromNullAndObject( Object object ) {
		String string = "" ;
	 ...
	 */
	public String cutString( String source , String output , int slength ) {
	 ...
	 * @return 지정길이로 잘라서 더할분자열 합친 문자열
	 */
	public String cutString( String source , int slength ) {
		String result = null ;
		if( source != null ) {
			if( source.length( ) > slength ) {
	 ...
	 */
	public String removeCommaChar( String str ) {
		return remove( str , ',' ) ;
	}
	 ...
	 */
	public String replaceOnce( String source , String subject , String object ) {
		StringBuffer rtnStr = new StringBuffer( ) ;
		String preStr = "" ;
		String nextStr = source ;
	 ...
	 * @return sb.toString() 새로운 문자열로 변환된 문자열
	 */
	public String replaceChar( String source , String subject , String object ) {
		StringBuffer rtnStr = new StringBuffer( ) ;
		String preStr = "" ;
		String nextStr = source ;
		String srcStr = source ;
	 ...
	 */
	public String decode( String sourceStr , String compareStr , String returnStr , String defaultStr ) {
	 ...
	 * 다르면 sourceStr을 반환한다.
	 */
	public String decode( String sourceStr , String compareStr , String returnStr ) {
	 ...
	 * </pre>
	 */
	public String nullConvert( Object src ) {
	 ...
	 * </pre>
	 */
	public String nullConvert( String src ) {
	 ...
	 * </pre>
	 */
	public int zeroConvert( Object src ) {
	 ...
	 * </pre>
	 */
	public int zeroConvert( String src ) {
	 ...
	 */
	public String checkHtmlView( String strString ) {
		String strNew = "" ;
	 ...
	 * @see
	 */
	public String getRandomStr( char startChr , char endChr ) {
	 ...
	 * @see
	 */
	public String getEncdDcd( String srcString , String srcCharsetNm , String cnvrCharsetNm ) {
	 ...
	 * @see
	 */
	public String getSpclStrCnvr( String srcString ) {
	 ...
	 * @return " - "가 추가된 입력문자열
	 */
	public String addMinusChar( String date ) {
		if( date.length( ) == 8 )
