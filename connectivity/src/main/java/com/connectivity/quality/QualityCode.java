...
public class QualityCode
{
	 ...
	 */
	public HashMap< String , Object > gatherOverFlow( String strQc , String gatherValStr , Map< String , Object > stdvDtMdlInfo , String tempRecordQc , HashMap< String , Object > gatherDataEventMap , String strDviceSkip ) {
